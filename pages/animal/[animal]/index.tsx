                    ...
                    <Grid container justifyContent="center"
                        ...
                        <Grid container justifyContent="center"
                          ...
                          <Grid item xs={12}>
                            <Grid container justifyContent="space-evenly"
                              ...
                              <Grid item xs={12} textAlign="center">
                                <Typography
                                    variant="h4">{animal.name}</Typography>
                      ...
                      <Grid item xs={12}>
                        <Grid container alignItems="center" spacing={2}>
                          ...
                          <Grid item>
                            <Typography variant="caption"
                                        color="text.secondary">Adicionado {intlFormatDistance(
                                parseISO(animal.createdAtISO), today,
                                {locale: ptBR.code})} por</Typography>
                            <Typography
                                variant="subtitle1">{animal.user?.name}</Typography>
                          </Grid>
                        </Grid>
                      </Grid>
                    </Grid>

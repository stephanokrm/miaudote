...
import {FormStoreData, FormCreateFieldValues, RawForm, Resource} from "../../types";
...
export const useFormStoreMutation = ({ setError }: UseFormStoreMutation) => {
    ...
    return useFormMutation<SuccessResponse, FormCreateFieldValues>(async (form) => {
        return axios().post<Response, SuccessResponse, FormStoreData>(`${process.env.NEXT_PUBLIC_SERVICE_URL}/api/form`, form)
    }, {
        setError,
